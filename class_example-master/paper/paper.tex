...
\title{Marriage Licence\thanks{Code and data are available at: LINK.}}
\author{Mingxuan Liu}
...
\maketitle
\begin{abstract}
Couples who marry in Ontario need to obtain a legal document: a Toronto
Marriage licence
\end{abstract}
